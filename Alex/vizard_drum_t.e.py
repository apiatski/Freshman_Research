...
drum_tom_sensor = vizproximity.Sensor(vizproximity.Box([.2,.2,.2],center=[.15,1, .1]),source= DrumTomModel)
...
#Add wand as proximity target 
#target = vizproximity.Target(viztracker.composite.storeTracker)
