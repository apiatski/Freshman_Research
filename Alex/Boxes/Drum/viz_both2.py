...
if x>0:
	...
	left_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],5,control_array[0]],[-x_translate1,y_height1-2.499,z_depth1]),left_node1)
	...
	right_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],5,control_array[0]],[x_translate1,y_height1-2.499,z_depth1]),right_node1)
