...
x_translate_shifted1=x_translate1+ 1
...
start_node= vizshape.addBox([.06,.06,.06],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color=viz.BLUE)
if x>0:
...
if x>0:
	...
	left_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],.01,control_array[0]],[-x_translate1,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],.01,control_array[0]],[x_translate1,y_height1,z_depth1]),right_node1)
...
if x>1:
	...
	left_plane_sensor2= vizproximity.Sensor(vizproximity.Box([control_array[1],.01,control_array[1]],[-x_translate1+50,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor2= vizproximity.Sensor(vizproximity.Box([control_array[1],.01,control_array[1]],[x_translate1+50,y_height1,z_depth1]),right_node1)
...
if x>2:
	...
	left_plane_sensor3= vizproximity.Sensor(vizproximity.Box([control_array[2],.01,control_array[2]],[-x_translate1+100,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor3= vizproximity.Sensor(vizproximity.Box([control_array[2],.01,control_array[2]],[x_translate1+100,y_height1,z_depth1]),right_node1)
...
if x>3:
	...
	left_plane_sensor4= vizproximity.Sensor(vizproximity.Box([control_array[3],.01,control_array[3]],[-x_translate1+150,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor4= vizproximity.Sensor(vizproximity.Box([control_array[3],.01,control_array[3]],[x_translate1+150,y_height1,z_depth1]),right_node1)
...
start_sensor=vizproximity.Sensor(vizproximity.Box([.06,.06,.06],center=[0,0,0]),start_node)
