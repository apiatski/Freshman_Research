...
import viztracker3nohandori as viztracker
...
y_height1= .78 + participant_height - standard_height
...
if x>0:
	...
	left_plane1.setPosition(-x_translate1-50,y_height1,z_depth1)
	...
	right_plane1.translate(x_translate1-50,y_height1,z_depth1)
if x>1:
	left_plane2= vizshape.addBox([control_array[1],.00001,control_array[1]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
	left_plane2.setPosition(-x_translate1+100,y_height1,z_depth1)
	...
	right_plane2.translate(x_translate1+100,y_height1,z_depth1)
if x>2:
	left_plane3= vizshape.addBox([control_array[2],.00001,control_array[2]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
	left_plane3.setPosition(-x_translate1+150,y_height1,z_depth1)
	...
	right_plane3.setPosition(x_translate1+150,y_height1,z_depth1)
if x>3:
	left_plane4= vizshape.addBox([control_array[3],.00001,control_array[3]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
	left_plane4.setPosition(-x_translate1+200,y_height1,z_depth1)
	...
	right_plane4.setPosition(x_translate1+200,y_height1,z_depth1)
if x>4:
	left_plane5= vizshape.addBox([control_array[4],.00001,control_array[4]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
	left_plane5.setPosition(-x_translate1+250,y_height1,z_depth1)
	...
	right_plane5.setPosition(x_translate1+250,y_height1,z_depth1)	
if x>5:
	left_plane6= vizshape.addBox([control_array[5],.00001,control_array[5]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>6:
	left_plane7= vizshape.addBox([control_array[6],.00001,control_array[6]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>7:
	left_plane8= vizshape.addBox([control_array[7],.00001,control_array[7]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>8:
	left_plane9= vizshape.addBox([control_array[8],.00001,control_array[8]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>9:
	left_plane10= vizshape.addBox([control_array[9],.00001,control_array[9]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>10:
	left_plane11= vizshape.addBox([control_array[10],.00001,control_array[10]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>11:
	left_plane12= vizshape.addBox([control_array[11],.00001,control_array[11]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>12:
	left_plane13= vizshape.addBox([control_array[12],.00001,control_array[12]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>13:
	left_plane14= vizshape.addBox([control_array[13],.00001,control_array[13]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>14:
	left_plane15= vizshape.addBox([control_array[14],.00001,control_array[14]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>15:
	left_plane16= vizshape.addBox([control_array[15],.00001,control_array[15]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>16:
	left_plane17= vizshape.addBox([control_array[16],.00001,control_array[16]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>17:
	left_plane18= vizshape.addBox([control_array[17],.00001,control_array[17]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>18:
	left_plane19= vizshape.addBox([control_array[18],.00001,control_array[18]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
if x>19:
	left_plane20= vizshape.addBox([control_array[19],.00001,control_array[19]],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.GREEN)
...
left_plane1.color(0,.5,0)
left_plane2.color(0,.5,0)
left_plane3.color(0,.5,0)
left_plane4.color(0,.5,0)
left_plane5.color(0,.5,0)
left_plane6.color(0,.5,0)
left_plane7.color(0,.5,0)
left_plane8.color(0,.5,0)
left_plane9.color(0,.5,0)
left_plane10.color(0,.5,0)
left_plane11.color(0,.5,0)
left_plane12.color(0,.5,0)
left_plane13.color(0,.5,0)
left_plane14.color(0,.5,0)
left_plane15.color(0,.5,0)
left_plane16.color(0,.5,0)
left_plane17.color(0,.5,0)
left_plane18.color(0,.5,0)
left_plane19.color(0,.5,0)
left_plane20.color(0,.5,0)

right_plane1.color(0,.5,0)
right_plane2.color(0,.5,0)
right_plane3.color(0,.5,0)
right_plane4.color(0,.5,0)
right_plane5.color(0,.5,0)
right_plane6.color(0,.5,0)
right_plane7.color(0,.5,0)
right_plane8.color(0,.5,0)
right_plane9.color(0,.5,0)
right_plane10.color(0,.5,0)
right_plane11.color(0,.5,0)
right_plane11.color(0,.5,0)
right_plane12.color(0,.5,0)
right_plane13.color(0,.5,0)
right_plane14.color(0,.5,0)
right_plane15.color(0,.5,0)
right_plane16.color(0,.5,0)
right_plane17.color(0,.5,0)
right_plane18.color(0,.5,0)
right_plane19.color(0,.5,0)
right_plane20.color(0,.5,0)
...
if x>0:
	...
	def EnterProximity_left_plane_sensor1(left_plane_sensor1):
		...
		if control_var_left==1:
			times_entered_left_plane+=1
			control_var_left=0
			left_plane1.color(0,1.5,0)
			viz.playSound('boing!.wav')
	...
	def EnterProximity_right_plane_sensor1(right_plane_sensor1):
		...
		if control_var_right==1:
			times_entered_right_plane+=1
			control_var_right=0
			right_plane1.color(0,1.5,0)
			viz.playSound('boing!.wav')
...
if x>3:
	...
	def ExitProximity_left_plane_sensor_error4(left_plane_sesnor_error4):
		...
		global control_var_left
		control_var_left=0
		print('Times entered left plane error4: ', times_entered_left_plane_error3)
	...
	left_plane_sensor4= vizproximity.Sensor(vizproximity.Box([control_array[3],5,control_array[3]],[-x_translate1+150,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor4= vizproximity.Sensor(vizproximity.Box([control_array[3],5,control_array[3]],[x_translate1+150,y_height1-2.49,z_depth1]),right_node1)
...
if x>4:
	...
	def ExitProximity_right_plane_sensor_error5(right_plane_sensor_error5):
		...
		global control_var_right
		control_var_right=0
		print('Times entered right plane error4: ', times_entered_right_plane_error5)
	...
	left_plane_sensor5= vizproximity.Sensor(vizproximity.Box([control_array[4],5,control_array[4]],[-x_translate1+200,y_height1-2.49,z_depth1]),left_node1)
	...
	manager.onEnter(left_plane_sensor5,EnterProximity_left_plane_sensor5)
	manager.onExit(left_plane_sensor5,ExitProximity_left_plane_sensor5)
	
	right_plane_sensor5= vizproximity.Sensor(vizproximity.Box([control_array[4],5,control_array[4]],[x_translate1+200,y_height1-2.49,z_depth1]),right_node1)
...
if x>5:
	...
	left_plane_sensor6= vizproximity.Sensor(vizproximity.Box([control_array[5],5,control_array[5]],[-x_translate1+250,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor6= vizproximity.Sensor(vizproximity.Box([control_array[5],5,control_array[5]],[x_translate1+250,y_height1-2.49,z_depth1]),right_node1)
...
if x>6:
	...
	left_plane_sensor7= vizproximity.Sensor(vizproximity.Box([control_array[6],5,control_array[6]],[-x_translate1+300,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor7= vizproximity.Sensor(vizproximity.Box([control_array[6],5,control_array[6]],[x_translate1+300,y_height1-2.49,z_depth1]),right_node1)
...
if x>7:
	...
	left_plane_sensor8= vizproximity.Sensor(vizproximity.Box([control_array[7],5,control_array[7]],[-x_translate1+350,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor8= vizproximity.Sensor(vizproximity.Box([control_array[7],5,control_array[7]],[x_translate1+350,y_height1-2.49,z_depth1]),right_node1)
...
if x>8:
	...
	left_plane_sensor9= vizproximity.Sensor(vizproximity.Box([control_array[8],5,control_array[8]],[-x_translate1+400,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor9= vizproximity.Sensor(vizproximity.Box([control_array[8],5,control_array[8]],[x_translate1+400,y_height1-2.49,z_depth1]),right_node1)
...
if x>9:
	...
	left_plane_sensor10= vizproximity.Sensor(vizproximity.Box([control_array[9],5,control_array[9]],[-x_translate1+450,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor10= vizproximity.Sensor(vizproximity.Box([control_array[9],5,control_array[9]],[x_translate1+450,y_height1-2.49,z_depth1]),right_node1)
...
if x>10:
	...
	left_plane_sensor11= vizproximity.Sensor(vizproximity.Box([control_array[10],5,control_array[10]],[-x_translate1+500,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor11= vizproximity.Sensor(vizproximity.Box([control_array[10],5,control_array[10]],[x_translate1+500,y_height1-2.49,z_depth1]),right_node1)
...
if x>11:
	...
	left_plane_sensor12= vizproximity.Sensor(vizproximity.Box([control_array[11],5,control_array[11]],[-x_translate1+550,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor12= vizproximity.Sensor(vizproximity.Box([control_array[11],5,control_array[11]],[x_translate1+550,y_height1-2.49,z_depth1]),right_node1)
...
if x>12:
	...
	left_plane_sensor13= vizproximity.Sensor(vizproximity.Box([control_array[12],5,control_array[12]],[-x_translate1+600,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor13= vizproximity.Sensor(vizproximity.Box([control_array[12],5,control_array[12]],[x_translate1+600,y_height1-2.49,z_depth1]),right_node1)
...
if x>13:
	...
	def ExitProximity_right_plane_sensor_error14(right_plane_sensor_error14):
	...
	left_plane_sensor14= vizproximity.Sensor(vizproximity.Box([control_array[13],5,control_array[13]],[-x_translate1+650,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor14= vizproximity.Sensor(vizproximity.Box([control_array[13],5,control_array[13]],[x_translate1+650,y_height1-2.49,z_depth1]),right_node1)
...
if x>14:
	...
	left_plane_sensor15= vizproximity.Sensor(vizproximity.Box([control_array[14],5,control_array[14]],[-x_translate1+700,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor15= vizproximity.Sensor(vizproximity.Box([control_array[14],5,control_array[14]],[x_translate1+700,y_height1-2.49,z_depth1]),right_node1)
...
if x>15:
	times_entered_left_plane_error16=0
	times_entered_right_plane_error16=0
	...
	left_plane_sensor16= vizproximity.Sensor(vizproximity.Box([control_array[15],5,control_array[15]],[-x_translate1+750,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor16= vizproximity.Sensor(vizproximity.Box([control_array[15],5,control_array[15]],[x_translate1+750,y_height1-2.49,z_depth1]),right_node1)
...
if x>16:
	times_entered_left_plane_error17=0
	times_entered_right_plane_error17=0
	...
	left_plane_sensor17= vizproximity.Sensor(vizproximity.Box([control_array[16],5,control_array[16]],[-x_translate1+800,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor17= vizproximity.Sensor(vizproximity.Box([control_array[16],5,control_array[16]],[x_translate1+800,y_height1-2.49,z_depth1]),right_node1)
...
if x>17:
	times_entered_left_plane_error18=0
	times_entered_right_plane_error18=0
	...
	left_plane_sensor18= vizproximity.Sensor(vizproximity.Box([control_array[17],5,control_array[17]],[-x_translate1+850,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor18= vizproximity.Sensor(vizproximity.Box([control_array[17],5,control_array[17]],[x_translate1+850,y_height1-2.49,z_depth1]),right_node1)
...
if x>18:
	times_entered_left_plane_error19=0
	times_entered_right_plane_error19=0
	...
	left_plane_sensor19= vizproximity.Sensor(vizproximity.Box([control_array[18],5,control_array[18]],[-x_translate1+900,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor19= vizproximity.Sensor(vizproximity.Box([control_array[18],5,control_array[18]],[x_translate1+900,y_height1-2.49,z_depth1]),right_node1)
...
if x>19:
	times_entered_left_plane_error20=0
	times_entered_right_plane_error20=0
	...
	left_plane_sensor20= vizproximity.Sensor(vizproximity.Box([control_array[19],5,control_array[19]],[-x_translate1+950,y_height1-2.49,z_depth1]),left_node1)
	...
	right_plane_sensor20= vizproximity.Sensor(vizproximity.Box([control_array[20],5,control_array[20]],[x_translate1+950,y_height1-2.49,z_depth1]),right_node1)
...
start_sensor=vizproximity.Sensor(vizproximity.Box([maximum_size, 5, maximum_size],center=[0,0,0]),start_node)
...
def shift_all_planes(x):
	...
	elif (x>12 and iter_count==12):
		left_plane12.translate(0,50,0)
		left_plane13.translate(-x_translate1,y_height1,z_depth1)
		right_plane12.translate(0,50,0)
		right_plane13.translate(x_translate1,y_height1,z_depth1)
	elif (x>13 and iter_count==13):
		left_plane13.translate(0,50,0)
		left_plane14.translate(-x_translate1,y_height1,z_depth1)
		right_plane13.translate(0,50,0)
		right_plane14.translate(x_translate1,y_height1,z_depth1)
	elif (x>14 and iter_count==14):
		left_plane14.translate(0,50,0)
		left_plane15.translate(-x_translate1,y_height1,z_depth1)
		right_plane14.translate(0,50,0)
		right_plane15.translate(x_translate1,y_height1,z_depth1)
	elif (x>15 and iter_count==15):
		left_plane15.translate(0,50,0)
		left_plane16.translate(-x_translate1,y_height1,z_depth1)
		right_plane15.translate(0,50,0)
		right_plane16.translate(x_translate1,y_height1,z_depth1)
	elif (x>16 and iter_count==16):
		left_plane16.translate(0,50,0)
		left_plane17.translate(-x_translate1,y_height1,z_depth1)
		right_plane16.translate(0,50,0)
		right_plane17.translate(x_translate1,y_height1,z_depth1)
	elif (x>17 and iter_count==17):
		left_plane17.translate(0,50,0)
		left_plane18.translate(-x_translate1,y_height1,z_depth1)
		right_plane17.translate(0,50,0)
		right_plane18.translate(x_translate1,y_height1,z_depth1)
	elif (x>18 and iter_count==18):
		left_plane18.translate(0,50,0)
		left_plane19.translate(-x_translate1,y_height1,z_depth1)
		right_plane18.translate(0,50,0)
		right_plane19.translate(x_translate1,y_height1,z_depth1)
	elif (x>19 and iter_count==19):
		left_plane19.translate(0,50,0)
		left_plane20.translate(-x_translate1,y_height1,z_depth1)
		right_plane19.translate(0,50,0)
		right_plane20.translate(x_translate1,y_height1,z_depth1)
...
#	end_box.setPosition(x_translate_shifted1,y_height1,z_depth1)
	end_box.setPosition(x_translate_shifted1,y_height1,z_depth1)
	if x>0:
		left_plane1.setPosition(0,-100,0)
		right_plane1.setPosition(0,-100,0)
	if x>1: 
		left_plane2.setPosition(0,-100,0)
		right_plane2.setPosition(0,-100,0)
	if x>2: 
		left_plane3.setPosition(0,-100,0)
		right_plane3.setPosition(0,-100,0)
	if x>3: 
		left_plane4.setPosition(0,-100,0)
		right_plane4.setPosition(0,-100,0)	
	if x>4: 
		left_plane5.setPosition(0,-100,0)
		right_plane5.setPosition(0,-100,0)
	if x>5: 
		left_plane6.setPosition(0,-100,0)
		right_plane6.setPosition(0,-100,0)
	if x>6: 
		left_plane7.setPosition(0,-100,0)
		right_plane7.setPosition(0,-100,0)
	if x>7: 
		left_plane8.setPosition(0,-100,0)
		right_plane8.setPosition(0,-100,0)
	if x>8: 
		left_plane9.setPosition(0,-100,0)
		right_plane9.setPosition(0,-100,0)
	if x>9: 
		left_plane10.setPosition(0,-100,0)
		right_plane10.setPosition(0,-100,0)
	if x>10: 
		left_plane11.setPosition(0,-100,0)
		right_plane11.setPosition(0,-100,0)
	if x>11: 
		left_plane12.setPosition(0,-100,0)
		right_plane12.setPosition(0,-100,0)
	if x>12: 
		left_plane13.setPosition(0,-100,0)
		right_plane13.setPosition(0,-100,0)
	if x>13: 
		left_plane14.setPosition(0,-100,0)
		right_plane14.setPosition(0,-100,0)
	if x>14: 
		left_plane15.setPosition(0,-100,0)
		right_plane15.setPosition(0,-100,0)
	if x>15: 
		left_plane16.setPosition(0,-100,0)
		right_plane16.setPosition(0,-100,0)
	if x>16: 
		left_plane17.setPosition(0,-100,0)
		right_plane17.setPosition(0,-100,0)
	if x>17: 
		left_plane18.setPosition(0,-100,0)
		right_plane18.setPosition(0,-100,0)
	if x>18: 
		left_plane19.setPosition(0,-100,0)
		right_plane19.setPosition(0,-100,0)
	if x>19: 
		left_plane20.setPosition(0,-100,0)
		right_plane20.setPosition(0,-100,0)
...
def EnterProximity_end_sensor(end_sensor):
	...
	main_data.write(' '*3+'le:'+str(global_time_entered_l))
	main_data.write(' '*0+'re:'+str(global_time_entered_r))
	main_data.write(' '*0 + str(total_error)+'\n')
