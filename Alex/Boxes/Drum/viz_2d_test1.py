3#In this experiment, the visual planes disappear when the subject leaves the start sensor. However, whenever he/she
#enters the box sensor (where the plane should be), a sound is triggered to notify him/her of the entrance. The subject
#sees the next pair of planes when he/she enters the start sensor again. 
#general viz module
import viz
#vizinfo is used 4along w/ vizinput to gather input throughout the program 
import vizinfo
...
start_node.translate(x_translate1,y_height1+.75,z_depth1)
#n=0
