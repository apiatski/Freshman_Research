...
if x>0:
	...
	left_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],.04,control_array[0]],[-x_translate1,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],04,control_array[0]],[x_translate1,y_height1,z_depth1]),right_node1)
...
if x>1:
	...
	left_plane_sensor2= vizproximity.Sensor(vizproximity.Box([control_array[1],.04,control_array[1]],[-x_translate1+50,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor2= vizproximity.Sensor(vizproximity.Box([control_array[1],.04,control_array[1]],[x_translate1+50,y_height1,z_depth1]),right_node1)
...
#	end_box.setPosition(x_translate_shifted1,y_height1,z_depth1)
	end_box.setPosition(x_translate1,y_height1,z_depth_translate)
