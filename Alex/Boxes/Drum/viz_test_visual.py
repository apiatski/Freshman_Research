...
if x>2:
	...
	def ExitProximity_left_plane_sensor3(left_plane_sensor3):
...
if x>19:
	...
	left_plane_sensor_error20=vizproximity.Sensor(vizproximity.Box([error_dim,error_dim,error_dim],[-x_translate1+900,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor_error20=vizproximity.Sensor(vizproximity.Box([error_dim,error_dim,error_dim],[x_translate1+900,y_height1,z_depth1]),right_node1)
	...
	left_plane_sensor20= vizproximity.Sensor(vizproximity.Box([control_array[19],5,control_array[19]],[-x_translate1+900,y_height1-2.49,z_depth1]),left_node1)
	...
	def EnterProximity_left_plane_sensor20(left_plane_sensor20):
		...
		if control_var_left==1:
			...
			control_var_left=0
			left_plane20.color(0,1.5,0)

	def ExitProximity_left_plane_sensor20(left_plane_sensor20):
	...
	right_plane_sensor20= vizproximity.Sensor(vizproximity.Box([control_array[19],5,control_array[19]],[x_translate1+900,y_height1-2.49,z_depth1]),right_node1)
	...
	def EnterProximity_right_plane_sensor20(right_plane_sensor20):
		...
		if control_var_right==1:
			...
			control_var_right=0
			right_plane20.color(0,1.5,0)		


	def ExitProximity_right_plane_sensor20(right_plane_sensor20):
		print('Exited right_plane_sensor20')
		right_plane20.color(0,.5,0)
