...
right_hand_object = viztracker.get('righthand') 
...
target = vizproximity.Target((right_hand_object))
manager.addTarget(target)
   
#vizact.onkeydown('d',manager.setDebug,viz.TOGGLE) 
def switch_trackers1():
	viztracker.PPT_Wand_ID=1
	viztracker.PPT_Head_ID=0


def switch_trackers2():
	viztracker.PPT_Wand_ID=0
	viztracker.PPT_Hand_ID=1
vizact.onkeydown('o', switch_trackers1())
vizact.onkeydown('p', switch_trackers2())
...
""" for demo:
don't have stick out of hand; don't model hand/just drumstick?
test hand orientation; will it still target properly?
will the old drum demo work w/ tracking?
vizconnect"""
