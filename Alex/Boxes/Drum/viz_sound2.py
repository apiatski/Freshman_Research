...
table= vizshape.addBox([50,00001,50],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color= viz.PURPLE)
...
if x>19:
	...
	right_plane_sensor20= vizproximity.Sensor(vizproximity.Box([control_array[20],5,control_array[20]],[x_translate1+900,y_height1-2.49,z_depth1]),right_node1)
...
#	end_box.setPosition(x_translate_shifted1,y_height1,z_depth1)
	...
	#This is the part for making the visual planes disappear. 
	if x>0:
