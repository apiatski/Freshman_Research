...
This is the Fitt. experiment that includes only auditory cues, and not visual ones."""
#general viz module
#the start box parameters are set by the maximum_size variable. find that variable, and set it to whatever value
#you want it to be if you want it to be a static value. 
import viz
...
#start_node= vizshape.addBox([maximum_size, maximum_size, maximum_size],right=True,left=True,top=True,bottom=True, front=True,back=True, splitFaces=False, color=viz.BLUE)
if x>0:
...
if x>0:
	...
	left_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],.02,control_array[0]],[-x_translate1,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor1= vizproximity.Sensor(vizproximity.Box([control_array[0],02,control_array[0]],[x_translate1,y_height1,z_depth1]),right_node1)
...
if x>1:
	...
	left_plane_sensor2= vizproximity.Sensor(vizproximity.Box([control_array[1],.02,control_array[1]],[-x_translate1+50,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor2= vizproximity.Sensor(vizproximity.Box([control_array[1],.02,control_array[1]],[x_translate1+50,y_height1,z_depth1]),right_node1)
...
if x>2:
	...
	left_plane_sensor3= vizproximity.Sensor(vizproximity.Box([control_array[2],.04,control_array[2]],[-x_translate1+100,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor3= vizproximity.Sensor(vizproximity.Box([control_array[2],.04,control_array[2]],[x_translate1+100,y_height1,z_depth1]),right_node1)
...
if x>3:
	...
	left_plane_sensor4= vizproximity.Sensor(vizproximity.Box([control_array[3],.04,control_array[3]],[-x_translate1+150,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor4= vizproximity.Sensor(vizproximity.Box([control_array[3],.04,control_array[3]],[x_translate1+150,y_height1,z_depth1]),right_node1)
...
if x>4:
	...
	left_plane_sensor5= vizproximity.Sensor(vizproximity.Box([control_array[4],.04,control_array[4]],[-x_translate1+200,y_height1,z_depth1]),left_node1)
	...
	right_plane_sensor5= vizproximity.Sensor(vizproximity.Box([control_array[4],.04,control_array[4]],[x_translate1+200,y_height1,z_depth1]),right_node1)
