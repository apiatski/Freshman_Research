...
if x>10:
	...
	def ExitProximity_right_plane_sensor11(right_plane_sensor11):
		...
		right_plane11.color(0,.5,0)
		print('Times Entered right Plane6: ', times_entered_right_plane11)
