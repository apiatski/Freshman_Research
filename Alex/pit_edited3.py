...
"""
import viz
#import steve #for robot as avatar 
import vizact
import vizcam

import viztracker_HMDVideoVision as viztracker
from viztracker_HMDVideoVision import *

viz.setMultiSample(8)
viz.fov(37.5,1.25) #since Sensics zSight has 37.5 vert (1st value) and 46.9 horiz. 2nd value is 46.9/37.5
viztracker.go()

# Simulate head tracker using keyboard/mouse navigator
head_tracker = vizcam.addWalkNavigate() #look around with mouse and change position with WASD keys
head_tracker.setPosition([0,1.5,0])
viz.mouse.setVisible(False)

#Q Use head tracking to move and simulate falling?

#Q should be doing all of this with viztracker?
#vrpn = viz.add('vrpn7.dle')
#headPos = vrpn.addTracker( 'PPT0@'+PPT_MACHINE,0)
#head_tracker = headPos
...
avatar = viz.add('vcc_male2.cfg', pos=(0,0,5), euler=(180,0,0) )
#avatar = steve.Steve()
#avatar.setTracker(viz.MainView) #(viztracker_HMDVideoVision.MainView)?
avatar.disable(viz.INTERSECTION)
#avatar.setPosition(0,0,0.1)
avatar.state(3)
