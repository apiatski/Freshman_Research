...
import vizuniverse
import vizproximity
import viztrackerd as viztracker
...
handTracker = composite.getRawTracker(composite.LHAND) #try same for hand, just added this

viewpoint = viztracker.get('viewpoint')
movable = viztracker.get("movable")
lht=viztracker.get("lefthand")
def printData():
...
target = vizproximity.Target(LeftSensor)
